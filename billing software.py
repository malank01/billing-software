...
#,bg="#03C04A"
    ...
    def __init__(self,root):
        ...
        self.root.title("BILLING SOFT")
        bg_color="#074463"
        title=Label(self.root,text="BILLING SOFTWARE",bd=10,relief=GROOVE,bg=bg_color,fg="silver",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        #=====var====
        #====juices======
        self.sprite=IntVar()
        ...
        #===========cust Detail========
        F1=LabelFrame(self.root,text="Customer Details",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),bg=bg_color,fg="silver")

        F1.place(x=0,y=80,relwidth=1)

        cname_lbl=Label(F1,text="Name Of Customer",bg=bg_color,fg="white",font=("times new roman",15,"bold")).grid(row=0,column=0,padx=20,pady=5)
        ...
        bill_btn=Button(F1,text="Search",command=self.find_bill,bg=bg_color,fg="white",width=10,bd=7,font="arial 12 bold").grid(row=0,column=6,pady=10,padx=40)

        #======Juices Frame=======
        F2=LabelFrame(self.root,text="Juices",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="silver",bg=bg_color)
        F2.place(x=5,y=180,width=325,height=380)

        sprite_lbl1=Label(F2,text="Sprite",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        thumbsup_lbl1=Label(F2,text="Thumbs Up",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        coco_cola_lbl1=Label(F2,text="Coco Cola",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        sveen_Up_lbl1=Label(F2,text="7 Up",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        Dukes_lbl1=Label(F2,text="Dukes Soda",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        mirinda_lbl1=Label(F2,text="Mirinda",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        F3=LabelFrame(self.root,text="Chips",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="silver",bg=bg_color)
        F3.place(x=340,y=180,width=325,height=380)

        lays_lbl1=Label(F3,text="Lays",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        doritos_lbl1=Label(F3,text="Doritos",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        pringles_lbl1=Label(F3,text="Pringles",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        peppy_lbl1=Label(F3,text="Peppy",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        kurkure_lbl1=Label(F3,text="Kurkure",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        wheels_lbl1=Label(F3,text="Wheels",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        F4=LabelFrame(self.root,text="Chocolate",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="silver",bg=bg_color)
        F4.place(x=670,y=180,width=325,height=380)

        silk_lbl1=Label(F4,text="Silk Oreo",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        toblerone_lbl1=Label(F4,text="Toblerone",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        kitkat_lbl1=Label(F4,text="Kit kat",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        snicker_lbl1=Label(F4,text="Snickers",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        star_lbl1=Label(F4,text="5 Star",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        fuse_lbl1=Label(F4,text="Fuse",font=("times new roman",16,"bold"),bg=bg_color,fg="silver").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        #=======Button=======
        F6=LabelFrame(self.root,text="Bill Menu",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="silver",bg=bg_color)
        F6.place(x=0,y=560,relwidth=1,height=140)

        a1_lbl1=Label(F6,text="Total Juice Price",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=0,column=0,padx=20,pady=1,sticky="w")
        ...
        a2_lbl1=Label(F6,text="Total Chips Price",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=1,column=0,padx=20,pady=1,sticky="w")
        ...
        a3_lbl1=Label(F6,text="Total Chocolate Price",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky="w")
        ...
        b1_lbl1=Label(F6,text="Juice Tax",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=0,column=2,padx=20,pady=1,sticky="w")
        ...
        b2_lbl1=Label(F6,text="Chips Tax",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=1,column=2,padx=20,pady=1,sticky="w")
        ...
        b3_lbl1=Label(F6,text="Chocolate Tax",bg=bg_color,fg="silver",font=("times new roman",14,"bold")).grid(row=2,column=2,padx=20,pady=1,sticky="w")
        ...
        total=Button(btn_A,command=self.total,text="Total",bg=bg_color,fg="silver",bd=5,pady=15,width=11,font="arial 13 bold").grid(row=0,column=0,padx=5,pady=5)
        Generate_bill=Button(btn_A,command=self.bill_area,text="Generate Bill",bg=bg_color,fg="silver",bd=5,pady=15,width=11,font="arial 13 bold").grid(row=0,column=1,padx=5,pady=5)
        clear=Button(btn_A,text="Clear",command=self.clear_data,bg=bg_color,fg="silver",bd=5,pady=15,width=11,font="arial 13 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit=Button(btn_A,text="Exit",command=self.Exit_app,bg=bg_color,fg="silver",bd=5,pady=15,width=11,font="arial 13 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()

        F6=LabelFrame(self.root,bd=10,relief=GROOVE,fg="silver",bg=bg_color)
        ...
        txtscroll=Entry(F6,textvariable=scroll_text, font=('arial',50,'bold'), fg='silver', bd=10, bg=bg_color, width=150)
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            f1=open("C:\\Users\\VISHAL RAVAL\\Desktop\\Python_Project/"+str(self.bill.get())+".txt","w")
    ...
    def find_bill(self):
        present="no"
        for i in os.listdir("C:\\Users\\VISHAL RAVAL\\Desktop\\Python_Project/"):
            if i.split('.')[0]==self.search_bill.get():
                f1=open(f"C:\\Users\\VISHAL RAVAL\\Desktop\\Python_Project/{i}","r")
                self.txtarea.delete('1.0',END)
                for c in f1:
                    self.txtarea.insert(END,c)
                f1.close()
                present="yes"
        if present=="no":
